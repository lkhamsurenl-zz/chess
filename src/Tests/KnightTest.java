...
public class KnightTest extends TestCase {
    ...
    Knight white_knight = new Knight(true, 3, 2, chessBoard);
    Knight black_knight = new Knight(false, 6, 4, chessBoard);
    Bishop black_bishop = new Bishop(false, 2, 5, chessBoard);
    ...
    * */
    ...
    public void afterEachTest() {
        ...
        white_knight.setPosition(3, 2);
        black_knight.setPosition(6, 4);
    }
    ...
    * */
    ...
    public void testIsKnightMove() throws Exception {
        assertEquals(white_knight.isLegalKnightMove(2, 4), true);
        assertEquals(white_knight.isLegalKnightMove(1, 1), true);
        assertEquals(white_knight.isLegalKnightMove(4, 3), false);
    ...
    * */
    ...
    public void testIsAnyObstacle() throws Exception {
        assertEquals(white_knight.isAnyObstacle(2, 4), false);
        assertEquals(white_knight.isAnyObstacle(1, 1), false);
        // move the king to one of the locations
        white_king.setPosition(1, 3);
        assertEquals(white_knight.isAnyObstacle(1, 3), true);
    ...
    * */
    ...
    public void testIsReachable() throws Exception {
        assertEquals(white_knight.isReachable(2, 0), true);
        assertEquals(white_knight.isReachable(-1, 0), false);
    ...
    * */
    ...
    public void testIsValidMovement() throws Exception {
        ...
        black_bishop.setPosition(2, 3);
        System.out.println(black_bishop.getCurrent_row() + ", " + black_bishop.getCurrent_col());
        TestCase.assertTrue(white_knight.isValidMovement(3, 3));
    }
